...
[View all the icons and usage information at this gallery](https://ebi.emblstatic.net/web_guidelines/EBI-Icon-fonts/v1.1/).

Just reference the <code>[fonts.css](https://ebi.emblstatic.net/web_guidelines/EBI-Icon-fonts/v1.1/fonts.css)</code> stylesheet automatically loads a range of icon fonts that you can use.
...
- You can load the default CSS by linking to the v1.1 release at [https://ebi.emblstatic.net/web_guidelines/EBI-Icon-fonts/v1.1/fonts.css](https://ebi.emblstatic.net/web_guidelines/EBI-Icon-fonts/v1.1/fonts.css)
