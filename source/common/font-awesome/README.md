# NOTE on EBI usage of these icons

Inside here is the original Font Awesome 5 icon set in the `font-awesome/solid` directory.

Do not alter these as they may be overwritten, if you want to fork an icon, place it in the `font-awesome/forked-icons` directory, and delete the original.
